...
public class ZGLandmarkGenerator implements ILandmarkGenerator {
    ...
    public List<String> generateExecutionCommand(File dFile, File pFile) {
        ...
        command.add("lm=lm_zg(reasonable_orders=false, only_causal_landmarks=false, disjunctive_landmarks=true, conjunctive_landmarks=true, no_orders=true)");
