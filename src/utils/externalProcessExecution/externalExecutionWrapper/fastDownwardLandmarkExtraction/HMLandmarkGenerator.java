...
public class HMLandmarkGenerator implements ILandmarkGenerator {
    ...
    public List<String> generateExecutionCommand(File dFile, File pFile) {
        ...
        command.add("lm=lm_hm(reasonable_orders=false, only_causal_landmarks=false, disjunctive_landmarks=true, conjunctive_landmarks=true, no_orders=true)");
